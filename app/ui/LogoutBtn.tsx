...
export const LogoutBtn = async () => {
  ...
  return (
    ...
    action={async()=>{'use server';await signOut()}}><button type='submit' className={`bg-blue-600 w-full lg:w-auto text-center border-blue-50 box-border py-2 rounded ${hover}`}>Wyloguj</button></form>
  )
}
